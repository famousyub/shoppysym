...
$instance->setContainer(($this->privates['.service_locator.eENHvGr'] ?? $this->load('get_ServiceLocator_EENHvGrService.php'))->withContext('App\\Controller\\UserController', $this));
