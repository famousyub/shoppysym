...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/shopcart'), [0 => 'ROLE_USER'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/userpanel'), [0 => 'ROLE_USER'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/orders'), [0 => 'ROLE_USER'], NULL);
